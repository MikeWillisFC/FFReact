         ...
         <UnorderedList>
            ...
            <ListItem>
               <a href="/page/FF/CTGY/PersonalizedWeddingFavors">
                  ...
                  <ul class="subcategories hideMe" id="subcat-PersonalizedWeddingFavors" <mvt:if expr="l.settings:category:code EQ 'PersonalizedWeddingFavors' OR l.settings:childof:code EQ 'PersonalizedWeddingFavors' OR g.mainCTGYCode EQ 'PersonalizedWeddingFavors'"> style="display:block;"</mvt:if>>
